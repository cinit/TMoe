package cc.ioctl.tmoe.buildlogic.ksp
...
class FunctionHookEntryItemProcessor(
    ...
    override fun process(resolver: Resolver): List<KSAnnotated> {
        val symbols = resolver.getSymbolsWithAnnotation("cc.ioctl.tmoe.base.annotation.FunctionHookEntry")
        ...
        val hook = ClassName("cc.ioctl.tmoe.hook.base", "BaseDynamicHook")
        ...
        FileSpec.builder("cc.ioctl.tmoe.gen", "AnnotatedFunctionHookEntryList")
